...
/*
  //***************以下代码为定时器的默认设定（白天每小时工作45分钟，晚上关闭）如有需要可解除注释
  //D4引脚设为高电平（板载LED灯处于关闭状态）
  pin_data.d[1] = 255;
  //设置默认值
  ...
  //每次启动45分钟
  pin_data.duration = 45;

  //启动后，PWM的强度（在水培系统中就是水泵的流量）0-255
  pin_data.timer_pwm = 225;
  
  //循环赋值
  pin_data.dt = new String[pin_data.dtcount];
