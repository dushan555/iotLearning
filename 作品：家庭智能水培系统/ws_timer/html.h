    ...
    <div class="content">
       ...
       <script>
        ...
        <div class="card" id="duration">
            ...
            <button id="duration-45" duration="45" class="button button_small button_low">45分钟</button>
            <button id="duration-60" duration="60" class="button button_small button_low">60分钟</button>
            <button id="duration-120" duration="120" class="button button_small button_low">120分钟</button>
            <button id="duration-180" duration="180" class="button button_small button_low">180分钟</button>
        </div>
        <script>
