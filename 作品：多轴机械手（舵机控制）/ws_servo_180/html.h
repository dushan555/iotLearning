    ...
    <div class="content">
        <div class="card">
            ...
            <div class="pwm-card">
                ...
                <input type="range" id="D4" min="0" max="1" value="0" step="1" class="slide">
            ...
            <div class="pwm-card">
                ...
                <input type="range" id="D8" min="0" max="180" value="0" step="45" class="slide">
